...
DatePicker.prototype.formats = (function() {
    ...
    function getWordLengthFromList( string, collection, dateObject ) {
    ...
    return {
        ...
        mmm: function( string, dateObject ) {
            ...
            return string ? getWordLengthFromList( string, collection, dateObject ) : collection[ dateObject.month ]
        },
...
DatePicker.prototype.nodes = function( isOpen ) {
    ...
    var
        ...
        disabledList = calendarItem.disable,
        ...
        tableHead = (function( collection, fullList ) {

            // If the first day should be Monday, move Sunday to the end.
            if ( settings.firstDay ) {
                collection.push( collection.shift() )
                fullList.push( fullList.shift() )
            }
                    ...
                    _.group({
                        ...
                        item: function( counter ) {
                            return [
                                ...
                                'scope=col title="' + fullList[ counter ] + '"'
                            ]
                        }
                    })
                )
        ...
        createMonthLabel = function(override) {
            ...
            var monthsList = settings.showMonthsShort ? settings.monthsShort : settings.monthsFull

             // Materialize modified
            if (override == "short_months") {
              monthsList = settings.monthsShort;
            }
            ...
            if (override == "short_months")
                ...
                return monthsList[ selectedObject.month ];
                else return monthsList[ viewsetObject.month ];

            // If there's a need for a month selector
            return _.node( 'div', monthsList[ viewsetObject.month ], settings.klass.month )
        }, //createMonthLabel
		                ...
		                _.group({
		                    ...
		                    item: function( targetDate ) {
		                        ...
		                        var isSelected = selectedObject && selectedObject.pick == targetDate.pick,
		                            ...
		                            isDisabled = disabledList && calendar.disabled( targetDate ) || targetDate.pick < minLimitObject.pick || targetDate.pick > maxLimitObject.pick,
